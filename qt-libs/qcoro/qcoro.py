...
class subinfo(info.infoclass):
    def setTargets(self):
        ...
        for ver in ["0.9.0", "0.10.0", "0.11.0", "0.12.0"]:
        ...
        self.targetDigests["0.12.0"] = (["809afafab61593f994c005ca6e242300e1e3e7f4db8b5d41f8c642aab9450fbc"], CraftHash.HashAlgorithm.SHA256)
