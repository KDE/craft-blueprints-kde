...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        ...
        for ver in ["0.10.0", "0.11.0", "0.12.0", "0.13.0"]:
        ...
        self.targetDigests['0.13.0'] = (['5c04ad1c2f1142197544ddbce249c73b45c724bd683e6dc89bdefbc8e6be36e7'], CraftHash.HashAlgorithm.SHA256)
