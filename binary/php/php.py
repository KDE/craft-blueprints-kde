...
class subinfo(info.infoclass):
    def setTargets(self):
        ...
        for ver in versions:
            ...
            self.targetInstallPath[ver] = os.path.join("dev-utils-wins", "php")
...
class Package(BinaryPackageBase):
    ...
    def install(self):
        if not BinaryPackageBase.install(self):
            return False
        # TODO: ouch
        with open(os.path.join(self.imageDir(), "dev-utils-wins", "php", "php.ini-development"), "rt+") as ini:
            with open(os.path.join(self.imageDir(), "dev-utils-wins", "php", "php.ini"), "wt+") as out:
                ...
                for line in ini:
                    ...
                    out.write(line)
        return utils.createShim(os.path.join(self.imageDir(), "dev-utils-wins", "bin", "php.exe"),
                                os.path.join(self.imageDir(), "dev-utils-wins", "php", "php.exe"))
