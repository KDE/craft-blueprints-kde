...
class subinfo(info.infoclass):
    def setTargets(self):
        for ver in ["0.40.0", "0.42.2", "0.42.4"]:
        ...
        self.targetDigests["0.42.4"] = (["d09c44ebc3bd5bee7021c79f922fe8fb2fb57f7320f55e97ff9914d2346a591c"], CraftHash.HashAlgorithm.SHA256)
