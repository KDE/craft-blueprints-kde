...
class subinfo(info.infoclass):
    ...
    def setDependencies(self):
        if CraftCore.settings.getboolean("Packager", "UseCache") and not CraftCore.settings.getboolean("QtSDK", "Enabled", False):
            self.buildDependencies["dev-utils-win/qtbinpatcher"] = None
        self.runtimeDependencies["virtual/base"] = None
        self.buildDependencies["dev-utils-win/perl"] = None
        self.buildDependencies["dev-utils-win/winflexbison"] = None
