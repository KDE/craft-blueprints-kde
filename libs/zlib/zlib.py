...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        ...
        self.patchToApply["1.2.13"] = [("zlib-1.2.12-20220404.diff", 1)]
        self.targetDigests['1.2.13'] = (['d14c38e313afc35a9a8760dadf26042f51ea0f5d154b0630a31da0540107fb98'], CraftHash.HashAlgorithm.SHA256)
