...
class subinfo(info.infoclass):
    def setTargets(self):
        for ver in ["2.18.0", "2.20.0", "2.22.0"]:
        ...
        self.targetDigests["2.22.0"] = (["467c418c2640a178c6baad5be2e00d569842123763b80507721ab87eb7af8735"], CraftHash.HashAlgorithm.SHA256)
        self.description = "an implementation for VA-API (Video Acceleration API)"
        self.defaultTarget = "2.22.0"
