...
class subinfo(info.infoclass):
    def setTargets(self):
        ...
        for ver in ["2.1.1", "3.0.0", "3.2.0"]:
            self.targets[ver] = f"https://dev-www.libreoffice.org/src/mdds-{ver}.tar.xz"
        ...
        self.targetDigests["3.2.0"] = (["16defab556c53f94b463460ea2a1faab96e58bad2a95d7981300d2956534abbb"], CraftHash.HashAlgorithm.SHA256)
        if CraftCore.compiler.isMSVC():
            ...
            for ver in ["3.0.0", "3.2.0"]:
                self.patchToApply[ver] = [("mdds-3.0.0_MSVC-c++17.patch", 1)]
