...
class subinfo(info.infoclass):
    def setTargets(self):
        for ver in ["1.2.0", "1.3.0", "1.4.3", "1.5.3", "1.5.4"]:
        ...
        self.targetDigests["1.5.3"] = (["e099f53253f6c247580c554d53a13f1040638f2066edc3c740e4c2f15174ce22"], CraftHash.HashAlgorithm.SHA256)
        self.targetDigests["1.5.4"] = (["2abfb0c89212e6e4733a54e0ae509ec00a5b845a6360946f918806e14aedb011"], CraftHash.HashAlgorithm.SHA256)
