...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        ...
        self.description = "GNU Scientific Library fork with CMake support"
...
class Package(CMakePackageBase):
    def __init__(self, **kwargs):
        ...
        self.subinfo.options.configure.args += ["-DCMAKE_POLICY_VERSION_MINIMUM=3.5", "-DGSL_DISABLE_TESTS=ON", "-DNO_AMPL_BINDINGS=ON"]
