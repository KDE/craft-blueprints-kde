...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        ...
        self.targetInstSrc["3.0.0"] = f"pthreads4w-code-07053a521b0a9deb6db2a649cde1f828f2eb1f4f"
        ...
        self.patchToApply["8e467a6"] = [
            ("pthreads-20240811.patch", 1),
            # https://github.com/microsoft/vcpkg/blob/7cfd63db7ff8855ab8e2baebeb80b37f5c0818db/ports/pthreads/PThreads4WConfig.cmake
            ("pthreads-20250710.patch", 1),
        ]
