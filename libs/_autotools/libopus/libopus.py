...
class subinfo(info.infoclass):
    def setTargets(self):
        ...
        if CraftCore.compiler.isMinGW():
            self.patchToApply["1.3.1"] = [("libopus-1.3.1-20220324.diff", 1)] # https://github.com/msys2/MINGW-packages/blob/7c67d9c46554d10276b2017bcfd0290dfe24a1bf/mingw-w64-opus/PKGBUILD#L36
