...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        for ver in ["1.9.1", "1.11.1", "1.12", "1.13", "1.13.1"]:
        ...
        self.targetDigests["1.13.1"] = (["c8da2b10f1bfec2cd7dbfcd33f4a2338db0765d851a50583d410bacf055cfd0b"], CraftHash.HashAlgorithm.SHA256)
