...
class subinfo(info.infoclass):
    def setTargets(self):
        ...
        self.targetInstallPath['master'] = 'dev-utils-wins/uncrustify'
        for ver in ['0.64']:
            ...
            self.targetInstallPath[ver] = 'dev-utils-wins/uncrustify'
...
class Package(CMakePackageBase):
    ...
    def install(self):
        if not CMakePackageBase.install(self):
            return False
        return utils.createShim(os.path.join(self.imageDir(), "dev-utils-wins", "bin", "uncrustify.exe"),
                                os.path.join(self.imageDir(), "dev-utils-wins", "uncrustify", "uncrustify.exe"))
