...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        ...
        self.patchToApply["2.6.4"] = [("0001-flex-disable-documentation.patch", 1), ("0002-build-AC_USE_SYSTEM_EXTENSIONS-in-configure.ac.patch", 1)] # https://git.busybox.net/buildroot/commit/?id=c128c5f3c79b31d89256ffbc5c650ba613d3d52b
