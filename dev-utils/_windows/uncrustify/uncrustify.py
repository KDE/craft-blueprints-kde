...
class subinfo(info.infoclass):
    def setTargets(self):
        ...
        self.targetInstallPath['master'] = 'dev-utilss/uncrustify'
        for ver in ['0.64']:
            ...
            self.targetInstallPath[ver] = 'dev-utilss/uncrustify'
...
class Package(CMakePackageBase):
    ...
    def install(self):
        if not CMakePackageBase.install(self):
            return False
        return utils.createShim(os.path.join(self.imageDir(), "dev-utilss", "bin", "uncrustify.exe"),
                                os.path.join(self.imageDir(), "dev-utilss", "uncrustify", "uncrustify.exe"))
